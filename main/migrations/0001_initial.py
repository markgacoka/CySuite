...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SubdomainModel',
            fields=[
                ('project_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='subdomain', serialize=False, to='cyauth.account')),
                ('project', models.TextField(blank=True, max_length=30)),

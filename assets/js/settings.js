!(function (t) {
  ...
  function (t, n, e) {
    t.exports =
      ...
      !e(4)(function () {
        return (
          7 !=
          Object.defineProperty(e(48)("div"), "a", {
            get: function () {
              return 7;
            },
          }).a
    ...
    r(
      ...
      "Array",
      {
        slice: function (t, n) {
          ...
          for (
            var o = c(t, e), u = c(n, e), l = a(u - o), f = new Array(l), p = 0;
            p < l;
            p++
          )
  ...
  function (t, n, e) {
    "use strict";
    var r = e(40);
    e(2)({ target: "RegExp", proto: !0, forced: r !== /./.exec }, { exec: r });
  },
  function (t, n, e) {
    var r = e(30),
      o = e(21);
  ...
  function (t, n, e) {
    ...
    var r = e(1),
      ...
      K = function (t) {
        ...
        return (
          !(this === D && o(N, t) && !o(B, t)) &&
          (!(n || !o(this, t) || !o(N, t) || (o(this, C) && this[C][t])) || n)
        );
      },
      Q = function (t, n) {
        if (((t = x(t)), (n = S(n, !0)), t !== D || !o(N, n) || o(B, n))) {
          var e = E(t, n);
          return (
            !e || !o(N, n) || (o(t, C) && t[C][n]) || (e.enumerable = !0), e
          );
        }
      },
      Y = function (t) {
    ...
    z ||
      ...
      (e(33).f = K),
      (e(42).f = X),
      i && !e(32) && a(D, "propertyIsEnumerable", K, !0),
      (d.f = function (t) {
        return V(h(t));
      })),
      ...
      return [
        ...
        function (t, n) {
          ...
          for (var x, S = "", w = 0, O = 0; O < b.length; O++) {
            ...
            for (
              var j = String(m[0]),
                k = u(l(c(m.index), p.length), 0),
                T = [],
                A = 1;
              A < m.length;
              A++
            )
              T.push(void 0 === (x = m[A]) ? x : String(x));
            var E = m.groups;
            if (h) {
    ...
    t.exports = function (t, n, e, y, g, b, m) {
      ...
      if (
        (_ &&
          ...
          w.next &&
          (u(w, j, !0), r || "function" == typeof w[f] || c(w, f, v)),
        k &&
          E &&
          E.name !== d &&
          ((T = !0),
        ...
        if (((x = { values: k ? P : O(d), keys: b ? P : O(h), entries: L }), m))
        ...
        function L(t, n) {
          !(function (t, n, e) {
            ...
            if (
              ...
              for (; ".." === A[0]; ) m.pop(), A.shift();
              t.path =
                ("/" !== n.charAt(0) ? m.join("/") : "") + "/" + A.join("/");
            }
        ...
        from: function (t) {
          ...
          if (
            ...
            for (f = b.call(p), e = new h(); !(o = f.next()).done; g++)
              u(e, g, y ? c(f, v, [o.value, g], !0) : o.value);
          return (e.length = g), e;
        },
      }
    );
  ...
  function (t, n, e) {
    ...
    var c = new (e.n(r).a)(),
      ...
      y = function () {
        setTimeout(function () {
          S("visited") ||
            (document.querySelector(s).classList.toggle("open"),
            w("visited", !0));
        }, 1e3);
      },
      g = function () {
